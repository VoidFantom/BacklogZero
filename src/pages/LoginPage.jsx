...
export default function LoginPage() {
  ...
  return (
    <div className="app-container flex flex-col items-center justify-center p-6 bg-surface" style={{ background: 'linear-gradient(135deg, var(--bg-color) 0%, #FFFFFF 100%)' }}>
      <div className="w-full max-w-sm text-center mb-8 mt-auto pt-8">
        <h1 className="text-4xl font-bold mb-3">Backlog<span className="text-primary">Zero</span></h1>
      ...
      <div className="card w-full max-w-sm shadow-xl" style={{ boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.05), 0 8px 10px -6px rgba(0, 0, 0, 0.01)' }}>
        ...
        <button 
          ...
          disabled={loading}
          className="btn btn-outline w-full flex items-center justify-center gap-2 py-3 bg-white"
        >
