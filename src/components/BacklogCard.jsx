  ...
  return (
    <div className="card">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="p-2 rounded-lg" style={{ backgroundColor: '#EEF2FF', color: 'var(--primary)' }}>
          <BookOpen size={20} />
        </div>
      </div>
      ...
      <div>
        ...
        {todaysTasks.length === 0 ? (
          <div className="text-sm text-muted p-4 bg-gray-50 rounded-lg text-center" style={{ backgroundColor: '#F8FAFC' }}>
          ...
          <div className="flex flex-col gap-2">
            {todaysTasks.map(task => {
              ...
              return (
                <div key={task.id} className="checkbox-container p-3 rounded-lg" style={{ backgroundColor: isChecked ? '#F8FAFC' : 'transparent', opacity: isChecked ? 0.6 : 1 }}>
                  <input 
                    type="checkbox" 
